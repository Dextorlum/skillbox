...
public class Main
{
    ...
    private static Logger wrongInputLogger;
    ...
    public static void main(String[] args)
    {
        ...
        logger = LogManager.getLogger("input_logger");
        errorLogger = LogManager.getRootLogger();
        wrongInputLogger = LogManager.getLogger("wrong_input_logger");
    ...
    {   
        for(;;)
        {
            ...
            wrongInputLogger.warn("Станция не найдена :" + line);
